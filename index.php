                ...
                <td scope="row"><?php echo $nro_indice; ?></td><?php $nro_indice = $nro_indice + 1;?>
                    ...
                    <td>
                        <div role="group" aria-label="Basic example">
                            ...
                            <a href="borrar_registro.php?id=<?php echo $campo->id; ?>"><button class="btn-primary" onclick="return confirm('Estas seguro de eliminar?');"  ><i class="bi bi-trash"></i></button></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
